						...
						<div class="box-body">
							...
							<div class="box-body">
								<div class="form-group">
									<label>Judul</label>
									<input type="hidden" name="id" value="<?php echo $a->aid; ?>">
									<input type="text" name="judul" class="form-control" placeholder="Masukkan judul artikel.." value="<?php echo $a->ajudul; ?>">
									<br/>
							...
							<div class="box-body">
								<div class="form-group">
									...
									<br/>
									<textarea class="form-control" id="editor" name="konten"> <?php echo $a->akonten; ?> </textarea>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<select class="form-control" name="kategori">
									...
									<?php foreach($kategori as $k){ ?>
										<option <?php if($a->akategori == $k->kid){echo "selected='selected'";} ?> value="<?php echo $k->kid ?>"><?php echo $k->knama; ?></option>
									<?php } ?>
								</select>
								<br/>
