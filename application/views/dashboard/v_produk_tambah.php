						...
						<div class="box-body">
							...
							<div class="box-body">
								<div class="form-group">
									<label>Judul</label>
									<input type="text" name="judul" class="form-control" placeholder="Masukkan judul produk.." value="<?php echo set_value('judul'); ?>">
									<br/>
							...
							<div class="form-group">
								...
								<select class="form-control" name="kategori">
									...
									<?php foreach($kategori as $k){ ?>
										<option <?php if(set_value('kategori') == $k->kid){echo "selected='selected'";} ?> value="<?php echo $k->kid ?>"><?php echo $k->knama; ?></option>
									<?php } ?>
								</select>
								<br/>
