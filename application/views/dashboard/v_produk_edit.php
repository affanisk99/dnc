						...
						<div class="box-body">
							...
							<div class="box-body">
								<div class="form-group">
									...
									<input type="text" name="judul" class="form-control" placeholder="Masukkan judul produk.." value="<?php echo $a->pjudul; ?>">
									<br/>
							...
							<div class="box-body">
								<div class="form-group">
									...
									<br/>
									<textarea class="form-control" id="editor" name="konten"> <?php echo $a->pkonten; ?> </textarea>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<select class="form-control" name="kategori">
									...
									<?php foreach($kategori as $k){ ?>
										<option <?php if($a->pkategori == $k->kid){echo "selected='selected'";} ?> value="<?php echo $k->kid ?>"><?php echo $k->knama; ?></option>
									<?php } ?>
								</select>
								<br/>
